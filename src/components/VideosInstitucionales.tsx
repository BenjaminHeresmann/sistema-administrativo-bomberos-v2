...
import { Play, Calendar, Clock, Users, Award, History, X, Maximize } from 'lucide-react';
  ...
  const videosInstitucionales = [
    {
      ...
      embedId: "E_6d3JBBo4s", // Video real sobre bomberos de Chile
      duracion: "15:30",
      categoria: "Historia",
    ...
    },
    {
      ...
      embedId: "j8PxqgliIno", // Video sobre valores bomberiles
      duracion: "8:45",
      categoria: "Valores",
    ...
    },
    {
      ...
      embedId: "ScMzIvxBSi4", // Video de capacitación bomberil
      duracion: "22:15",
    ...
    },
    {
      ...
      embedId: "kxopViU98Xo", // Video ceremonial bomberil
      duracion: "12:30",
    ...
    },
    {
      ...
      embedId: "JO_vkdWzEoo", // Video sobre organización bomberil
      duracion: "10:20",
    ...
    },
    {
      ...
      embedId: "Js_rHjqROgc", // Video de actividades comunitarias
      duracion: "18:45",
      categoria: "Comunidad",
          ...
          return (
            <Card key={video.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              <CardHeader className="p-0">
                ...
                <div 
                  className="relative bg-gradient-to-br from-muted to-muted/60 h-48 flex items-center justify-center group cursor-pointer"
                ...
                >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      // Fallback a thumbnail de calidad media si maxres no existe
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-primary/90 hover:bg-primary text-white rounded-full p-4 transition-all duration-300 group-hover:scale-110 shadow-lg">
                  ...
                  <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="bg-black/70 hover:bg-black/90 text-white rounded-md p-2 transition-colors">
        ...
        <DialogContent className="max-w-4xl w-full p-0">
          ...
          {selectedVideo && (
            <div className="relative aspect-video">
              <iframe
                src={`https://www.youtube.com/embed/${selectedVideo.embedId}?autoplay=1&modestbranding=1&rel=0`}
                title={`Video institucional: ${selectedVideo.titulo}`}
          ...
          {selectedVideo && (
            <div className="px-6 py-4 space-y-3">
              <div className="flex items-center gap-2">
                {(() => {
                  const categoriaInfo = getCategoriaInfo(selectedVideo.categoria);
                  const Icon = categoriaInfo.icon;
                  return (
                    <Badge className={`${categoriaInfo.color} text-white flex items-center gap-1`}>
                      <Icon className="w-3 h-3" />
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  Publicado: {new Date(selectedVideo.fechaPublicacion).toLocaleDateString('es-CL')}
                </div>
                <div className="flex items-center gap-1">
                  <Users className="w-4 h-4" />
                  {selectedVideo.visualizaciones} visualizaciones
                </div>
              </div>
            </div>
          )}
