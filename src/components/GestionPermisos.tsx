...
export function GestionPermisos({ onNavigate, userProfile }: GestionPermisosProps) {
  ...
  // Función para forzar recarga completa desde defaults
  const handleForceReload = () => {
    ...
    setPendingChanges({});
    setHasUnsavedChanges(false);
    toast.success('Permisos recargados desde configuración por defecto.');
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={handleForceReload} className="bg-blue-600 hover:bg-blue-700 text-white">
